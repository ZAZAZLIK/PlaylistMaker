...
class CreatePlaylistFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // НЕ устанавливаем фон с пунктирной рамкой - она должна быть только в add_image_icon
        // Обводка не нужна, так как иконка уже содержит визуальное обозначение
        
        // Настраиваем обработку кнопки "Назад" в AppBar
        // Устанавливаем обработчик сразу, но также переопределяем в onResume для надежности
    ...
    override fun onResume() {
        super.onResume()
        // Убеждаемся, что обработчик установлен после каждого возобновления
        setupToolbarNavigation()
    }
